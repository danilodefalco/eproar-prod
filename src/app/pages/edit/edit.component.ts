...
export class EditComponent implements OnInit {
	...
	fillForm() {
		this.form.patchValue({
			id: this.area.id,
			car: this.area.car,
			nomeProdutor: this.area.nomeProdutor,
			responsavel: this.area.responsavel,
			responsavelCpf: this.area.responsavelCpf,
			ap1: this.area.ap1 ? this.area.ap1 : "0",
			ap2: this.area.ap2 ? this.area.ap2 : "0",
			ap3: this.area.ap3 ? this.area.ap3 : "0",
			ap4: this.area.ap4 ? this.area.ap4 : "0",
			sistemaPlantio: this.area.sistemaPlantio
				? this.area.sistemaPlantio
				: "convencional",
			totalProduzido: this.area.totalProduzido ? this.area.totalProduzido : "0",
			producaoHa: this.area.producaoHa ? this.area.producaoHa : "0",
			aq1: this.area.aq1 ? this.area.aq1 : "0",
			aq2: this.area.aq2 ? this.area.aq2 : "0",
			aq3: this.area.aq3 ? this.area.aq3 : "0",
			aq4: this.area.aq4 ? this.area.aq4 : "0",
			porcentagemAreaQueimada: this.area.porcentagemAreaQueimada
				? this.area.porcentagemAreaQueimada
				: "0",
			calcarioCalcitico: this.area.calcarioCalcitico
				? this.area.calcarioCalcitico
				: "0",
			calcarioDolomotico: this.area.calcarioDolomotico
				? this.area.calcarioDolomotico
				: "0",
			gesso: this.area.gesso ? this.area.gesso : "0",
			ureia: this.area.ureia ? this.area.ureia : "0",
			map1: this.area.map1 ? this.area.map1 : "0",
			map2: this.area.map2 ? this.area.map2 : "0",
			dap1: this.area.dap1 ? this.area.dap1 : "0",
			dap2: this.area.dap2 ? this.area.dap2 : "0",
			nitratoAmonio: this.area.nitratoAmonio ? this.area.nitratoAmonio : "0",
			uan: this.area.uan ? this.area.uan : "0",
			amoniaAnidra: this.area.amoniaAnidra ? this.area.amoniaAnidra : "0",
			sulfatoAmonio: this.area.sulfatoAmonio ? this.area.sulfatoAmonio : "0",
			can: this.area.can ? this.area.can : "0",
			ssp: this.area.ssp ? this.area.ssp : "0",
			tsp: this.area.tsp ? this.area.tsp : "0",
			kci: this.area.kci ? this.area.kci : "0",
			vinhaca: this.area.vinhaca ? this.area.vinhaca : "0",
			tortaFiltroBaseUmida: this.area.tortaFiltroBaseUmida
				? this.area.tortaFiltroBaseUmida
				: "0",
			cinzasFuligemBaseUmida: this.area.cinzasFuligemBaseUmida
				? this.area.cinzasFuligemBaseUmida
				: "0",

			dieselB8: this.area.dieselB8 ? this.area.dieselB8 : "0",
			dieselB10: this.area.dieselB10 ? this.area.dieselB10 : "0",
			dieselBx: this.area.dieselBx ? this.area.dieselBx : "0",
			dieselB20: this.area.dieselB20 ? this.area.dieselB20 : "0",
			dieselB30: this.area.dieselB30 ? this.area.dieselB30 : "0",
			biodieselB100: this.area.biodieselB100 ? this.area.biodieselB100 : "0",
			gasolina: this.area.gasolina ? this.area.gasolina : "0",
			etanol: this.area.etanol ? this.area.etanol : "0",
			biometranoTerceiros: this.area.biometranoTerceiros
				? this.area.biometranoTerceiros
				: "0",
			biometranoProprio: this.area.biometranoProprio
				? this.area.biometranoProprio
				: "0",
			eletricidadeRede: this.area.eletricidadeRede
				? this.area.eletricidadeRede
				: "0",
			eletricidadePch: this.area.eletricidadePch
				? this.area.eletricidadePch
				: "0",
			eletricidadeBiomassa: this.area.eletricidadeBiomassa
				? this.area.eletricidadeBiomassa
				: "0",
			eletricidadeEolica: this.area.eletricidadeEolica
				? this.area.eletricidadeEolica
				: "0",
			eletricidadeSolar: this.area.eletricidadeSolar
				? this.area.eletricidadeSolar
				: "0",

			totalEtanolProduzidoLitros: this.area.totalEtanolProduzidoLitros
				? this.area.totalEtanolProduzidoLitros
				: "0",
			totalMj: this.area.totalMj ? this.area.totalMj : "0",
			totalCreditoCarbono: this.area.totalCreditoCarbono
				? this.area.totalCreditoCarbono
				: "0",
		});
	}
	...
	error(err) {
		this.toastrService.error("Erro", "Erro ao editar a área!", {
			progressBar: true,
		});
	}
